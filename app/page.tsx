...
export default function Home() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#08080F] text-gray-100">
      ...
      <div className="mx-auto flex min-h-screen max-w-2xl flex-col px-6 py-16 sm:py-24">
        <header className="mb-10">
          ...
          <h1 className="mt-2 text-4xl font-semibold tracking-tight text-white sm:text-5xl">
            Ride{" "}
            <span className="bg-gradient-to-r from-[#60A5FA] via-[#F472B6] to-[#A3E635] bg-clip-text text-transparent">
              Recap
            </span>
          </h1>
